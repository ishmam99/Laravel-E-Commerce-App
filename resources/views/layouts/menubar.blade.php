							...
							<div class="cat_menu_container">
								...
								<ul class="cat_menu">
									...
									<li class="hassubs">
										...
										<ul>
											<?php $sub=DB::table('subcategories')->where('category_id',$item->id)->get(); ?>
											@foreach ($sub as $subcategories)
												
											
											<li class="hassubs">
												<a href="#">{{$subcategories->subcategory_name}}</a>
			...
			<div class="row fill_height">
				...
				<div class="col-lg-5 offset-lg-4 fill_height">
					<div class="banner_content">
						...
						<div class="banner_price">@if ($slider->discount_price)
