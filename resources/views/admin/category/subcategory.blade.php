            ...
            <table id="datatable1" class="table display responsive nowrap">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                      <a href="{{route('edit.subcategory',['id' => $subcat->id]) }}" class="btn btn-sm btn-info">Edit</a>
                      
                      <a href="{{url('delete/subcategory/'.$subcat->id)}}" class="btn btn-sm btn-danger" id="delete">Delete</a>
                  </td>
