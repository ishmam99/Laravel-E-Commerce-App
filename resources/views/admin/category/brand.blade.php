              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{$brand->brand_name}}</td>
                   <td> <img src="{{URL::to($brand->brand_logo)}}" height="60px;" width="80px;" alt=""></td>
                  <td>
                      <a href="{{route('brand.edit',['id' => $brand->id]) }}" class="btn btn-sm btn-info">Edit</a>
                      
                      <a href="{{url('delete/brand/'.$brand->id)}}" class="btn btn-sm btn-danger" id="delete">Delete</a>
                  </td>
