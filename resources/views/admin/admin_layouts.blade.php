...
<html lang="en">
  ...
  <body>
   ...
   @guest
    ...
    @else
         <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href=""><i class="icon ion-store-front-sharp"></i><i class="fas fa-store-alt"></i> Amar <span class="tx-info tx-normal">DUKAN</span></a></div>
            ...
            <div class="dropdown-menu dropdown-menu-header wd-200">
              <ul class="list-unstyled user-profile-nav">
                ...
                <li>
                  ...
                  <a href="{{route('admin.logout')}}"><i class="icon ion-power"></i> </>Logout</a></li>
